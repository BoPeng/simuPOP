# R
scenarios = c(
  'Simulating scenario  0 N  1000 m  0.0001 mu  0.01',
  'Simulating scenario  1 N  1000 m  0.0001 mu  0.001',
  'Simulating scenario  2 N  1000 m  0.0001 mu  0.0001')
...
analyze <- function(sce)
{
  ...
  dev.off()
  return(list(mean=quan[4,], re=cbind(ret, quan[c(4,5),dim(fst)[1]])))
}


 a= analyze(5)

# find the moving average of a$mean

plot(a$mean)

for(i in 11:200)
{
  b[i] = mean(a$mean[(i-10):i])
}
