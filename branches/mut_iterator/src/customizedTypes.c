...
/// CPPONLY
typedef struct arrayobject_template<MutantIterator> arrayobject_mutant;                      /* Forward */


/// CPPONLY
bool is_carrayobject_mutant(PyObject * op);

/// CPPONLY
static PyObject *
getarrayitem_mutant(arrayobject_mutant * op, Py_ssize_t i)
{
	return getarrayitem_template<MutantIterator>(op, i);
}


/// CPPONLY
static int
setarrayitem_mutant(arrayobject_mutant * ap, Py_ssize_t i, PyObject * v)
{
	return setarrayitem_template<MutantIterator>(ap, i, v);
}


/// CPPONLY
static PyObject *
carray_new_mutant(PyTypeObject * a, PyObject * b, PyObject * c)
{
	return carray_new_template<MutantIterator>(a, b, c);
}


/// CPPONLY
static PyObject *
carray_init_mutant(PyTypeObject * a, PyObject * b, PyObject * c)
{
	return carray_init_template<MutantIterator>(a, b, c);
}


/// CPPONLY
PyObject * newcarrayobject_mutant(MutantIterator begin, MutantIterator end);

/// CPPONLY
static void
array_dealloc_mutant(arrayobject_mutant * op)
{
	array_dealloc_template<MutantIterator>(op);
}


/// CPPONLY
static PyObject *
array_richcompare_mutant(PyObject * v, PyObject * w, int op)
{
	return(array_richcompare_template<MutantIterator>(v, w, op));
}


/// CPPONLY
static Py_ssize_t array_length_mutant(arrayobject_mutant * a)
{
	return(array_length_template<MutantIterator>(a));
}


/// CPPONLY
static PyObject * array_concat_mutant(arrayobject_mutant * a, PyObject * o)
{
	return(array_concat_template<MutantIterator>(a, o));
}


/// CPPONLY
static PyObject * array_repeat_mutant(arrayobject_mutant * a, Py_ssize_t i)
{
	return(array_repeat_template<MutantIterator>(a, i));
}


/// CPPONLY
static PyObject * array_item_mutant(arrayobject_mutant * a, Py_ssize_t i)
{
	return(array_item_template<MutantIterator>(a, i));
}


/// CPPONLY
static PyObject * array_slice_mutant(arrayobject_mutant * a, Py_ssize_t ilow, Py_ssize_t ihigh)
{
	return(array_slice_template<MutantIterator>(a, ilow, ihigh));
}


/// CPPONLY
static int array_ass_slice_mutant(arrayobject_mutant * a, Py_ssize_t ilow, Py_ssize_t ihigh, PyObject * v)
{
	return(array_ass_slice_template<MutantIterator>(a, ilow, ihigh, v));
}


/// CPPONLY
static Py_ssize_t array_ass_item_mutant(arrayobject_mutant * a, Py_ssize_t i, PyObject * v)
{
	return(array_ass_item_template<MutantIterator>(a, i, v));
}


/// CPPONLY
static PyObject * array_count_mutant(arrayobject_mutant * self, PyObject * args)
{
	return(array_count_template<MutantIterator>(self, args));
}


/// CPPONLY
static char count_doc_mutant [] =
    "count(x)\n\
\n\
Return number of occurences of x in the array."                                          ;

/// CPPONLY
static PyObject * array_index_mutant(arrayobject_mutant * self, PyObject * args)
{
	return(array_index_template<MutantIterator>(self, args));
}


static char index_doc_mutant [] =
    "index(x, [start, [stop]])\n\
\n\
Return index of first occurence of x in the array.";

/// CPPONLY
static PyObject * array_tolist_mutant(arrayobject_mutant * self, PyObject * args)
{
	return(array_tolist_template<MutantIterator>(self, args));
}


static char tolist_doc_mutant [] =
    "tolist() -> list\n\
\n\
Convert array to an ordinary list with the same items."                                                          ;

#pragma GCC diagnostic ignored "-Wmissing-field-initializers"
PyMethodDef array_methods_mutant[] =
{
	{
		"count", (PyCFunction)array_count_mutant, METH_VARARGS,
		count_doc_mutant
	},
	{
		"index", (PyCFunction)array_index_mutant, METH_VARARGS,
		index_doc_mutant
	},
	{
		"tolist",    (PyCFunction)array_tolist_mutant,    METH_VARARGS,
		tolist_doc_mutant
	},
	{                                                                                             /* sentinel */
		NULL,        NULL
...
/// CPPONLY
static PyObject * array_getattr_mutant(arrayobject_mutant * a, char * name)
{
	if (strcmp(name, "__members__") == 0) {
		PyObject * list = PyList_New(0);
		return list;
	}
	return Py_FindMethod(array_methods_mutant, (PyObject *)a, name);
}


/// CPPONLY
static int array_print_mutant(arrayobject_mutant * a, FILE * fp, int flags)
{
	return(array_print_template<MutantIterator>(a, fp, flags));
}


/// CPPONLY
static PyObject *
array_repr_mutant(arrayobject_mutant * a)
{
	return(array_repr_template<MutantIterator>(a));
}


static PySequenceMethods array_as_sequence_mutant =
{
#  if PY_VERSION_HEX < 0x02050000
	(inquiry)array_length_mutant,                                                      /*sq_length*/
	(binaryfunc)array_concat_mutant,                                                   /*sq_concat*/
	(intargfunc)array_repeat_mutant,                                                   /*sq_repeat*/
	(intargfunc)array_item_mutant,                                                     /*sq_item*/
	(intintargfunc)array_slice_mutant,                                                 /*sq_slice*/
	(intobjargproc)array_ass_item_mutant,                                              /*sq_ass_item*/
	(intintobjargproc)array_ass_slice_mutant,                                          /*sq_ass_slice*/
#  else
	(lenfunc)array_length_mutant,                                                      /*sq_length*/
	(binaryfunc)array_concat_mutant,                                                   /*sq_concat*/
	(ssizeargfunc)array_repeat_mutant,                                                 /*sq_repeat*/
	(ssizeargfunc)array_item_mutant,                                                   /*sq_item*/
	(ssizessizeargfunc)array_slice_mutant,                                             /*sq_slice*/
	(ssizeobjargproc)array_ass_item_mutant,                                            /*sq_ass_item*/
	(ssizessizeobjargproc)array_ass_slice_mutant,                                      /*sq_ass_slice*/
#  endif
};

static char arraytype_doc_mutant [] =
    "An array represents underlying memory of simuPOP structure \n\
so that you can edit the values in python. The type will behave \n\
very much like lists, except that you can change its size.\n\
\n\
...
PyTypeObject MutantArraytype =
{
	PyObject_HEAD_INIT(NULL)
	0,
	"simuPOP.carray_mutant",   /* mudule.type name */
	sizeof(arrayobject_mutant),
	0,
	(destructor)array_dealloc_mutant,  /* tp_dealloc */
	(printfunc)array_print_mutant,     /* tp_print */
	(getattrfunc)array_getattr_mutant, /* tp_getattr */
	0,                          /* tp_setattr */
	0,                          /* tp_compare */
	(reprfunc)array_repr_mutant,       /* tp_repr */
	0,                          /* tp_as _number*/
	&array_as_sequence_mutant, /* tp_as _sequence*/
	0,                          /* tp_as _mapping*/
	0,                          /* tp_hash */
	0,                          /* tp_call */
	0,                          /* tp_str */
	...
	0,                          /* tp_as_buffer*/
	Py_TPFLAGS_DEFAULT,         /* tp_flags */
	arraytype_doc_mutant,      /* tp_doc */
	0,                          /* tp_traverse */
	0,                          /* tp_clear */
	array_richcompare_mutant,  /* tp_richcompare */
	0,                          /* tp_weaklistoffset */
	0,                          /* tp_iter */
	0,                          /* tp_iternext */
	0,                          /* tp_methods */
	...
	0,                          /* tp_descr_set */
	0,                          /* tp_dictoffset */
	(initproc)carray_init_mutant,      /* tp_init */
	0,                          /* tp_alloc */
	carray_new_mutant,         /* tp_new */
};
...
bool is_carrayobject_mutant(PyObject * op)
{
	return is_carrayobject_template<MutantIterator>(op);
}
...
PyObject * newcarrayobject_mutant(MutantIterator begin, MutantIterator end)
{
	return(newcarrayobject_template<MutantIterator>(begin, end));
}
...
typedef struct arrayobject_template<MutantIterator> arrayobject_mutant;
...
static PyObject *
getarrayitem_mutant(PyObject * op, Py_ssize_t i)
{
	return getarrayitem_template<MutantIterator>(op, i);
}
...
/// CPPONLY
static int
setarrayitem_mutant(arrayobject_mutant * ap, int i, PyObject * v)
{
	return setarrayitem_template<MutantIterator>(ap, i, v);
}
...
static Py_ssize_t
array_length_mutant(arrayobject_mutant * a)
{
	return array_length_template<MutantIterator>(a);
}
...
static PyObject *
array_item_mutant(arrayobject_mutant * a, Py_ssize_t i)
{
	return array_item_template<MutantIterator>(a, i);
}
...
static PyObject *
array_slice_mutant(arrayobject_mutant * a, Py_ssize_t ilow, Py_ssize_t ihigh)
{
	return array_slice_template<MutantIterator>(a, ilow, ihigh);
}
...
static int
array_ass_slice_mutant(arrayobject_mutant * a, Py_ssize_t ilow, Py_ssize_t ihigh, PyObject * v)
{
	return array_ass_slice_template<MutantIterator>(a, ilow, ihigh, v);
}
...
static int
array_ass_item_mutant(arrayobject_mutant * a, Py_ssize_t i, PyObject * v)
{
	return array_ass_item_template<MutantIterator>(a, i, v);
}
...
static PyObject *
array_count_mutant(arrayobject_mutant * self, PyObject * v)
{
	return array_count_template<MutantIterator>(self, v);
}


PyDoc_STRVAR(count_doc_mutant,
	"count(x)\n\
\n\
Return number of occurrences of x in the array."                     );

static PyObject *
array_index_mutant(arrayobject_mutant * self, PyObject * v)
{
	return array_index_template<MutantIterator>(self, v);
}


PyDoc_STRVAR(index_doc_mutant,
	"index(x)\n\
\n\
Return index of first occurrence of x in the array."                     );

static PyObject *
array_tolist_mutant(arrayobject_mutant * self, PyObject * unused)
{
	return array_tolist_template<MutantIterator>(self, unused);
}


PyDoc_STRVAR(tolist_doc_mutant,
	"tolist() -> list\n\
\n\
Convert array to an ordinary list with the same items."                             );


static PyMethodDef array_methods_mutant[] = {
	{ "count",	(PyCFunction)array_count_mutant,	METH_O,
	  count_doc_mutant },
	{ "index",	(PyCFunction)array_index_mutant,	METH_O,
	  index_doc_mutant },
	{ "tolist", (PyCFunction)array_tolist_mutant,	METH_NOARGS,
	  tolist_doc_mutant },
	{ NULL,		NULL }      /* sentinel */
};
...
static PyObject*
array_subscr_mutant(arrayobject_mutant* self, PyObject* item)
{
	return array_subscr_template<MutantIterator>(self, item);
}


static int
array_ass_subscr_mutant(arrayobject_mutant* self, PyObject* item, PyObject* value)
{
	return array_ass_subscr_template<MutantIterator>(self, item, value);
}

static PyMappingMethods array_as_mapping_mutant = {
	(lenfunc)array_length_mutant,
	(binaryfunc)array_subscr_mutant,
	(objobjargproc)array_ass_subscr_mutant
};

PyObject * array_new_mutant(PyTypeObject * type, PyObject * args, PyObject * kwds)
{
	return array_new_template<MutantIterator>(type, args, kwds);
}


PyDoc_STRVAR(arraytype_doc_mutant,
	" \n\
\n\
Methods:\n\
\n\
...
PyTypeObject MutantArraytype = {
	...
	(reprfunc)array_repr_mutant,                       /* tp_repr */
	0,                                          /* tp_as_number*/
	&array_as_sequence_mutant,                         /* tp_as_sequence*/
	&array_as_mapping_mutant,                          /* tp_as_mapping*/
	0,                                          /* tp_hash */
	0,                                          /* tp_call */
	0,                                          /* tp_str */
	PyObject_GenericGetAttr,                    /* tp_getattro */
	...
	0,                                          /* tp_iter */
	0,                                          /* tp_iternext */
	array_methods_mutant,                              /* tp_methods */
	0,                                          /* tp_members */
	0,                                          /* tp_getset */
	0,                                          /* tp_base */
	0,                                          /* tp_dict */
