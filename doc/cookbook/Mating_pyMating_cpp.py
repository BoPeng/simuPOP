...
'''
 ...
 3. compile the wrapper, and your .cpp files (if available)
	...
	> g++ -shared Mating_pyMating_cpp_wrap.o /usr/lib64/libstdc++.so.5 -o _Mating_pyMating_cpp_cpp.so

 4.	You can then try to import your module using

	> python -c 'import Mating_pyMating_cpp_cpp'
...
# parentsChooser_cpp is defined in Mating_pyMating_cpp.i, and it must
# be compiled to be imported into this script.
try:
    from Mating_pyMating_cpp_cpp import *
...
def parentsChooser(pop, sp):
    ...
    if has_cpp_chooser:
        ...
        while True:
            # this function is defined in Mating_pyMating_cpp.h
