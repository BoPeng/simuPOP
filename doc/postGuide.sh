...
cp -f userGuide.pdf /var/www/html/simuPOP_doc
rm -f userGuidePost.lyx
...
cp -f userGuide.css /var/www/html/simuPOP_doc/userGuide
cp -f userGuide.tex userGuide_single.tex
latex2html  -split 0 -show_section_numbers -no_navigation \
   userGuide_single.tex
cp userGuide_single/userGuide_single.html /var/www/html/simuPOP_doc/userGuide_single.html
cp -f *.png /var/www/html/simuPOP_doc/
...
mv -f refManualPost.tex refManual.tex
...
cp -f refManual.pdf /var/www/html/simuPOP_doc
...
cp -f refManual.css /var/www/html/simuPOP_doc/refManual
cp -f refManual.tex refManual_single.tex
latex2html  -split 0 -show_section_numbers -no_navigation \
   refManual_single.tex
cp refManual_single/refManual_single.html /var/www/html/simuPOP_doc/refManual_single.html
cp -f *.png /var/www/html/simuPOP_doc/
perl -pi.bak -e 's,\/home\/bpeng\/research\/simupop\/doc\/\/,,g' /var/www/html/simuPOP_doc/*.html


cp -f  ../INSTALL /var/www/html/simuPOP_doc/INSTALL.txt

cp -f ../ChangeLog /var/www/html/simuPOP_doc/ChangeLog
cp -f ../RoadMap /var/www/html/simuPOP_doc/RoadMap
