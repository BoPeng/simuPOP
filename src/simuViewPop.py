...
class popStatDialog(wx.Dialog):
  def __init__(self, *args, **kwds):
    ...
    self.nb_population_pane_4 = wx.Panel(self.nb_population, -1)
    ...
    self.sizer_num_male_staticbox = wx.StaticBox(self.panel_stat, -1, "Number of male")
    self.sizer_num_affected_staticbox = wx.StaticBox(self.panel_stat, -1, "Number of affected")
    ...
    self.sizer_export_fstat_staticbox = wx.StaticBox(self.nb_population_pane_4, -1, "Export to Fstat format")
    self.sizer_export_linkage_staticbox = wx.StaticBox(self.nb_population_pane_4, -1, "Export to Linkage format")
    ...
    self.listbox_loci = wx.ListBox(self.panel_genotype, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED|wx.LB_HSCROLL)
    ...
    self.cb_num_male = wx.CheckBox(self.panel_stat, -1, "number of male")
    self.cb_num_affected = wx.CheckBox(self.panel_stat, -1, "number of affected")
    self.listbox_num_allele = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    self.listbox_allelefreq = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    self.listbox_heterofreq = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    self.listbox_exp_hetero = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    self.listbox_homofreq = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    self.listbox_genofreq = wx.ListBox(self.panel_stat, -1, choices=[], style=wx.LB_MULTIPLE|wx.LB_EXTENDED)
    ...
    self.wnd_filling = filling.Filling(self.panel_stat, -1)
    self.btn_export_fstat = wx.Button(self.nb_population_pane_4, -1, "Export to Fstat", style=wx.BU_BOTTOM|wx.BU_EXACTFIT)
    self.btn_export_linkage = wx.Button(self.nb_population_pane_4, -1, "Export to Linkage", style=wx.BU_BOTTOM|wx.BU_EXACTFIT)
  ...
  def __set_properties(self):
    ...
    self.listbox_num_allele.SetMinSize((149, 77))
    self.listbox_allelefreq.SetMinSize((149, 77))
    self.listbox_heterofreq.SetMinSize((149, 77))
    self.listbox_exp_hetero.SetMinSize((152, 83))
    self.listbox_homofreq.SetMinSize((155, 83))
    self.listbox_genofreq.SetMinSize((155, 83))
    self.txt_haplofreq.SetMinSize((155, 83))
    self.txt_LD.SetMinSize((155, 83))
    self.panel_stat.SetScrollRate(10, 10)
    self.nb_population_pane_4.Enable(False)
    self.nb_population_pane_4.Hide()
    self.nb_population.SetMinSize((250, 654))
    # end wxGlade

  def __do_layout(self):
    # begin wxGlade: popStatDialog.__do_layout
    sizer_all = wx.BoxSizer(wx.VERTICAL)
    sizer_export = wx.BoxSizer(wx.VERTICAL)
    sizer_export_linkage = wx.StaticBoxSizer(self.sizer_export_linkage_staticbox, wx.HORIZONTAL)
    sizer_export_fstat = wx.StaticBoxSizer(self.sizer_export_fstat_staticbox, wx.HORIZONTAL)
    ...
    sizer_num_affected = wx.StaticBoxSizer(self.sizer_num_affected_staticbox, wx.HORIZONTAL)
    sizer_num_male = wx.StaticBoxSizer(self.sizer_num_male_staticbox, wx.HORIZONTAL)
    ...
    sizer_left_top.Add(self.txt_filename, 1, wx.RIGHT|wx.ADJUST_MINSIZE, 20)
    ...
    sizer_num_male.Add(self.cb_num_male, 0, wx.ADJUST_MINSIZE, 0)
    grid_sizer_stat.Add(sizer_num_male, 1, wx.EXPAND, 0)
    sizer_num_affected.Add(self.cb_num_affected, 0, wx.ADJUST_MINSIZE, 0)
    grid_sizer_stat.Add(sizer_num_affected, 1, wx.EXPAND, 0)
    sizer_num_alleles.Add(self.listbox_num_allele, 1, wx.ALL|wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_num_alleles, 1, wx.EXPAND, 0)
    sizer_allelefreq.Add(self.listbox_allelefreq, 1, wx.ALL|wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_allelefreq, 1, wx.EXPAND, 0)
    sizer_heterofreq.Add(self.listbox_heterofreq, 1, wx.ALL|wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_heterofreq, 1, wx.EXPAND, 0)
    sizer_exo_hetero.Add(self.listbox_exp_hetero, 1, wx.LEFT|wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_exo_hetero, 1, wx.EXPAND, 0)
    sizer_homofreq.Add(self.listbox_homofreq, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_homofreq, 1, wx.EXPAND, 0)
    sizer_genofreq.Add(self.listbox_genofreq, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_genofreq, 1, wx.EXPAND, 0)
    sizer_haplofreq.Add(self.txt_haplofreq, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_haplofreq, 1, wx.EXPAND, 0)
    sizer_LD.Add(self.txt_LD, 1, wx.EXPAND|wx.ADJUST_MINSIZE, 3)
    grid_sizer_stat.Add(sizer_LD, 1, wx.EXPAND, 0)
    sizer_stat_top.Add(grid_sizer_stat, 0, wx.ALL|wx.EXPAND, 0)
    sizer_stat_top.Add(self.wnd_filling, 1, wx.EXPAND, 0)
    ...
    sizer_export_fstat.Add(self.btn_export_fstat, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 20)
    sizer_export.Add(sizer_export_fstat, 1, wx.ALL|wx.EXPAND, 10)
    sizer_export_linkage.Add(self.btn_export_linkage, 0, wx.LEFT|wx.RIGHT|wx.TOP|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 20)
    sizer_export.Add(sizer_export_linkage, 1, wx.ALL|wx.EXPAND, 10)
    self.nb_population_pane_4.SetAutoLayout(True)
    self.nb_population_pane_4.SetSizer(sizer_export)
    sizer_export.Fit(self.nb_population_pane_4)
    sizer_export.SetSizeHints(self.nb_population_pane_4)
    ...
    self.nb_population.AddPage(self.nb_population_pane_4, "Export")
  ...
  def LoadPop(self, popFileName):
    if popFileName != None:  # give filename
...
''' % (self.pop.ploidy(), self.pop.ploidyName(), \
  ...
  def setStatisticsInfo(self):
    ...
    self.wnd_filling = filling.Filling(self.panel_stat, -1,
      rootObject=self.pop.vars(), rootLabel="pop.vars()")
    self.sizer_stat_top.Add(self.wnd_filling, 1, wx.EXPAND, 0)
...
class viewPopApp(wx.App):
  def __init__(self, popFileName=None, *args, **kwds):
    self.popFileName = popFileName
...
if __name__ == "__main__":
  from simuPOP import *
  if len(sys.argv) > 1:   # viewPop filename
    app = viewPopApp(popFileName=sys.argv[1])
  else:
    app = viewPopApp(popFileName=None)
  app.MainLoop()
