...
void core::CoalescenceEvent::print_(std::ostream &os) const
{
...
void core::RecombinationEvent::print_(std::ostream &os) const
{
...
void core::GeneConversionEvent::print_(std::ostream &os) const
{
...
void core::PopulationMerge::print_(std::ostream &os) const
{
  os << "PopulationMerge(";
