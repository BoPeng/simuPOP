...
'''
 ...
 3. An interface file Mating_homoMating_cpp.i, which tells an automatic wrapper
 ...
 2. generate a wrap using command:
	...
	> swig -python -templatereduce -c++ -shadow -nodefaultctor  -keyword Mating_homoMating_cpp.i

	A wrapper file Mating_homoMating_cpp_wrap.cxx will be generated. Options -c++
 ...
 4.	You can then try to import your module using
	...
	> python -c 'import Mating_homoMating_cpp_impl'
...
try:
    from Mating_homoMating_cpp_impl import *
