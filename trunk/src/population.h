...
#define Haplodiploid 2.5
	 ...
	 *  absInd absolute index of an individual
	 *  a pair of values (subPop, index)
	 *  <group>2-subpop</group>
	 */
	...
	*/
	...
	/**
	  geno genotype to be set. It will be reused if its length
