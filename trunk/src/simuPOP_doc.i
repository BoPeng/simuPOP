...
Arguments:
    ...
    func:    a Python function that accept genotypes at susceptibility
      loci generation number, and return fitness value.
...
Details:
    This file is used to initialize simuPOP when being load into python.
  The swig interface file will has a init%  entry to include this
  file.
