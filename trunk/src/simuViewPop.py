...
class VariableRootFilling(wx.SplitterWindow):
  ...
  def setRoot(self, rootObject, rootLabel):
    ...
    print "Change root to ", rootLabel
    self.tree = filling.FillingTree(parent=self, rootObject=rootObject,
                rootLabel=rootLabel,
...
class popStatDialog(wx.Dialog):
  def __init__(self, *args, **kwds):
    ...
    self.nb_panel_convert = wx.Panel(self.nb_population, -1)
    ...
    self.sizer_export_fstat_staticbox = wx.StaticBox(self.nb_panel_convert, -1, "Export to Fstat format")
    self.sizer_export_linkage_staticbox = wx.StaticBox(self.nb_panel_convert, -1, "Export to Linkage format")
    ...
    self.btn_export_fstat = wx.Button(self.nb_panel_convert, -1, "Export to Fstat", style=wx.BU_BOTTOM|wx.BU_EXACTFIT)
    self.btn_export_linkage = wx.Button(self.nb_panel_convert, -1, "Export to Linkage", style=wx.BU_BOTTOM|wx.BU_EXACTFIT)
  ...
  def __set_properties(self):
    ...
    self.nb_panel_convert.Enable(False)
    self.nb_panel_convert.Hide()
    # end wxGlade
  ...
  def __do_layout(self):
    ...
    self.nb_panel_convert.SetAutoLayout(True)
    self.nb_panel_convert.SetSizer(sizer_export)
    sizer_export.Fit(self.nb_panel_convert)
    sizer_export.SetSizeHints(self.nb_panel_convert)
    ...
    self.nb_population.AddPage(self.nb_panel_convert, "Export")
