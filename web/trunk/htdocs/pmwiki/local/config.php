...
$ScriptUrl = 'http://simupop.sourceforge.net';
$PubDirUrl = 'http://simupop.sourceforge.net/pmwiki/pub';

# This follows suggestions from
#
# http://www.pmwiki.org/wiki/Cookbook/SourceForgeServers
#
session_save_path('/home/groups/s/si/simupop/persistent/web/sessions');
$WorkDir = "/home/groups/s/si/simupop/persistent/web/wiki.d";
$WikiDir = new PageStore('/home/groups/s/si/simupop/persistent/web/wiki.d/$FullName');

$UploadDir = '/home/groups/s/si/simupop/persistent/web/uploads';
...
$EnableUpload = 1;                       
$DefaultPasswords['upload'] = '$1$2WQKRtKw$RVpaMBwsMhaR7ZqBDcBWn0';
...
$LinkWikiWords = 0;                      # enable WikiWord links
